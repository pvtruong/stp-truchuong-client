var id_app;
var access_token;
var paths_not_require_id_app = ['code','app','colleague','notification','message','profile','users','comment','versioninfo','admin'];
...
accApp.run(['$rootScope','api','$window','user','app','$location','$http','appInfo','$timeout',function ($rootScope,api,$window,user,app,$location,$http,appInfo,$timeout) {
