angular.module('khuyenmaiModule',[])
	.directive('ngKhuyenmai',[function(){
	return {
		restrict:'E',
		scope:{
			ngData:'=',
		...
		templateUrl:'templates/vouchers/khuyenmai/templates/table.html',
		controller:['$scope','$modal','dmkh','dmvat','$timeout',function($scope,$modal,dmkh,dmvat,$timeout){
			...
			$scope.openDetail = function (size,template) {
				var modalInstance = $modal.open({
				  templateUrl: 'templates/vouchers/khuyenmai/templates/edit.html',
