...
dashboardModule.controller("homeController",['$scope','$localStorage','user','$rootScope','$location','$timeout','$http','api','$window','$interval','appInfo',function($scope,$localStorage,user,$rootScope,$location,$timeout,$http,api,$window,$interval,appInfo){
...
dashboardModule.config(['$routeProvider','$locationProvider','$httpProvider',function($routeProvider,$locationProvider,$httpProvider){
	...
	$routeProvider
		...
		.when("/admin",{
			templateUrl:"modules/dashboard/templates/admin.html",
