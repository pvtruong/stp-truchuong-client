...
appModule.module.controller('baseAppHomeController',function($scope,$location,$localStorage,$rootScope,app,$window){
			...
			appInfo.info("app",function(error,uerinfo,appinfo){
				...
				$scope.addDays = function(a){
					var modalInstance = $modal.open({
					  templateUrl: 'modules/lists/app/templates/add-days.html',
