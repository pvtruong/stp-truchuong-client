...
mailreceivedModule.module.directive("mailReceived",function(){
	return {
		...
		templateUrl:"modules/lists/mailreceived/templates/directive.html",
...
mailreceivedModule.module.directive("dbInbox",function(){
	return {
		...
		templateUrl:'modules/lists/mailreceived/templates/db.html',
		controller:['$scope','mailreceived','$rootScope','$location','$modal','socket','appInfo',function($scope,mailreceived,$rootScope,$location,$modal,socket,appInfo){
			appInfo.info("mailreceived",function(error,uerinfo,appinfo){
				if(error){
					return;
				}
