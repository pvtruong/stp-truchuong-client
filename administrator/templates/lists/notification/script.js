...
notificationModule.module.directive("dbNotify",function(){
	return {
		...
		templateUrl:'modules/lists/notification/templates/db.html',
		controller:['$scope','notification','$rootScope','$location','$modal','socket','appInfo',function($scope,notification,$rootScope,$location,$modal,socket,appInfo){
