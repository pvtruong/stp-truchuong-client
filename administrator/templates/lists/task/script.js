	...
	onLoading:function($scope,options){
		...
		$scope.searchAVG = function(){
			...
			if($scope.advCondition.start_date){
				$scope.filter.start_date = $scope.advCondition.start_date;
			}
			if($scope.advCondition.due_date){
				$scope.filter.due_date = $scope.advCondition.due_date;
			}else{
...
taskModule.module.directive("task",function(){
	return {
		...
		templateUrl:'modules/lists/task/templates/directive.html',
...
taskModule.module.directive("dbTask",function(){
	return {
		...
		templateUrl:'modules/lists/task/templates/db.html',
		controller:['$scope','task','$rootScope','$location','appInfo','socket',function($scope,task,$rootScope,$location,appInfo,socket){
