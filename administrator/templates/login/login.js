...
loginModule.factory("user",['$http','$localStorage','$rootScope','$location','socket',function($http,$localStorage,$rootScope,$location,socket){
	return {
		getInfo:function(fn){
			if($rootScope.user){
...
loginModule.config(['$routeProvider','$locationProvider',function($routeProvider,$locationProvider){
		$routeProvider
			...
			.when("/download",{
				templateUrl:"modules/login/templates/download.html",
